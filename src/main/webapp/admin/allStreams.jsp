...
<body>
	...
	<div class="container mt-5">
		<h2 class="text-center" style="color: black;">All Streams</h2>
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				List<StreamDetails> list = dao.getAllStreams();
				for (StreamDetails s : list) {
				%>
				<tr>
					<td><%=s.getTournament_name()%></td>
					<td><%=s.getStream_id()%></td>
					<td>
						<a href="../deleteStream?id=<%=s.getStream_id()%>" 
		...
		<div class="text-center">
			...
			<a href="stream.jsp" class="btn btn-primary">Add New Stream</a>
		</div>
