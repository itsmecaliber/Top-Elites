...
<body>
    ...
    <form action="../add_tournaments" method="post"
        ...
        <input type="date" id="tournamentDate" name="tournament_date" required>

        <label for="entryFee">Entry Fee:</label>
        <input type="number" id="entryFee" name="entry_fee" required>

        <label for="prizePool">Prize Pool:</label>
        <input type="number" id="prizePool" name="prize_pool" required>
        
        <label for="tournamentLogo">Tournament Logo:</label>
    	<input type="file" id="tournamentLogo" name="logo" accept="image/*" required>

        <button type="submit" class="button">Add Tournament</button>
    </form>
    <br>
    <button class="button" onclick="location.href='adhome.jsp'">Back to Dashboard</button>
</body>
</html>
