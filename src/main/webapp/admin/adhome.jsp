...
<body>
    ...
    <div class="button-container">
        <button class="button" onclick="location.href='addTournament.jsp'">Add a Tournament</button>
        <button class="button" onclick="location.href='allTournament.jsp'">All Tournaments</button>
        <button class="button" onclick="location.href='allStreams.jsp'">All Streams</button>
         <button class="button" onclick="location.href='allResults.jsp'">All Results</button>
        <button class="button" onclick="if(confirm('Are you sure you want to logout from this account?')) { location.href='../logout'; }">Logout</button>
    </div>
</body>
</html>
